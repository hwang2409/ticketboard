...
4. Local Codex reads that snapshot, reasons over the current project state, and writes a structured JSON brief.
...
| `pnpm brief:codex` | Ask local Codex to generate the workflow brief JSON. |
